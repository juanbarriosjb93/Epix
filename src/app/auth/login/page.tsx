...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-violet-600/20 rounded-full blur-[120px] animate-pulse-glow" />
      ...
      >
        <div className="glass-strong rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-400 text-sm mt-1">Sign in to your Epix account</p>
          </div>
          ...
          <p className="text-center text-sm text-zinc-400 mt-6">
            Don't have an account? <a href="/auth/register" className="text-violet-400 hover:text-violet-300">Sign up</a>
          </p>
        </div>
      </motion.div>
    </div>
